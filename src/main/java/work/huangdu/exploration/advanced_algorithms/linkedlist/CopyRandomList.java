...
public class CopyRandomList {
    public Node copyRandomList(Node head) {
        ...
        while (cur != null) {
            ...
            if (cur.next != null) { originNode.next = originNode.next.next; }
            cur = cur.next;
        }
        return newHead;
    }
    ...
    public Node copyRandomList2(Node head) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (i != n - 1) { curNode.next = copyNodeList.get(i + 1); }
            if (cur.random != null) { curNode.random = copyNodeList.get(nodeIndexMap.get(cur.random)); }
            cur = cur.next;
        }
